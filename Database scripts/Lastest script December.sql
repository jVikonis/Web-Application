...
Insert into favorites (userName, genrepreference, favorite1, favorite2, favorite3, crewPerson, recent1, recent2, recent3, ageRestriction) values
('Rabbit', 'Drama', 20, 15, 3, 5, 8, 0, 0, 'no'),
('Wolf', 'Drama', 20, 15, 3, 5, 6, 0, 0, 'no'),
('Lion', 'Action', 10, 15, 3, 5, 6, 9, 0, 'no'),
('Tiger', 'Comedy', 20, 5, 3, 5, 6, 0, 0, 'no'),
('Worm', 'Comedy', 20, 15, 3, 0, 6, 0, 0, 'no'),
('Lettuce', 'Drama', 20, 15, 3, 5, 6, 0, 0, 'yes'),
('Eagle', 'Horror', 30, 32, 3, 5, 6, 23, 0, 'no'),
('Kangaroo', 'Sci-Fi', 40, 25, 3, 5, 6, 31, 0, 'no');
...
alter table movie add column ratingSum int default 1;
alter table movie add column ratingCount int default 1;
alter table movie add column ratingAvg int as (ratingSum /ratingCount);
...
Insert into quotes (quoteid, quoteString, movieTitle) values
...
(40, "My mama always said life was like a box of chocolates.You never know what you're gonna get.", "FORREST GUMP"),
...
(85, "My precious.THE LORD OF THE RINGS : ", "TWO TOWERS"),
