...
INSERT INTO `movie` (`movieID`,`movieGenre`,`movieTitle`,`movieDescription`,`movieYearReleased`,`movieImage`,`movieTrailer`,`movieReleaseDate`,`movieMPAARating`,`director`,`actor1`,`actor2`) VALUES 
 ...
 (5,'Drama','A Bronx Tale','A father becomes worried when a local gangster befriends his son in the Bronx in the 1960s.','1993','ABronxTale.jpg','http://www.youtube.com/watch?v=1bkIqZfviXU','1993-09-29','R','Robert Deniro','Chazz Palminteri','Lillo Brancato\r'),
